...
此設定值在 [CI 環境][]中預設為 `true`。 用來偵測 CI 環境的程式碼如下：
...
* **ndjson** -- 最詳盡的 reporter Prints all logs in [ndjson](https://github.com/ndjson/ndjson-spec) format
...
[CI 環境]: https://github.com/watson/ci-info#supported-ci-tools
