...
If you have installed Node.js with `pnpm runtime` Corepack won't be installed on your system, you will need to install it separately. 請參閱 [#4029](https://github.com/pnpm/pnpm/issues/4029)。
...
- 一般版本的 [`pnpm`](https://www.npmjs.com/package/pnpm) 需要 Node.js 才能執行。 Since v11, pnpm is distributed as pure ESM.
