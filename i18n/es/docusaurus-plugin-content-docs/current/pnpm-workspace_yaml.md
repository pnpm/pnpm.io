...
`pnpm-workspace.yaml` defines the root of the [workspace][] and enables you to include / exclude directories from the workspace. If the `packages` field is omitted, only the root package is included in the workspace.
