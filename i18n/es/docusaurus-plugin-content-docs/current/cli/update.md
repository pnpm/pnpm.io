...
`pnpm update` actualiza los paquetes a su última versión basado en el rango especificado.
...
| Comando              | Significado                                                                                   |
| -------------------- | --------------------------------------------------------------------------------------------- |
| `pnpm up`            | Actualiza todas las dependencias, adhiriéndose a los rangos especificados en el`package.json` |
...
Actualiza las dependencias a su versión estable más reciente según lo determinado por sus etiquetas `latest` (potencialmente actualizando los paquetes a través de versiones principales) siempre y cuando el rango de versiones especificado en `package.json` sea inferior al de la etiqueta `latest` (es decir, no rebajará los prereleases).
