...
pnpm se puede usar fácilmente en varios sistemas de integración continua.
...
En Azure Pipelines, puede usar pnpm para instalar y almacenar en caché sus dependencias agregando esto a su `azure-pipelines.yml`:
...
Puede usar pnpm para instalar y almacenar en caché sus dependencias:
...
En CircleCI, puede usar pnpm para instalar y almacenar en caché sus dependencias agregando esto a su `.circleci/config.yml`:
...
En GitHub Actions, puede usar pnpm para instalar y almacenar en caché sus dependencias así (pertenece a `.github/workflows/NOMBRE.yml`):
...
En [Semaphore][], puede usar pnpm para instalar y almacenar en caché sus dependencias agregando esto a su `.semaphore/semaphore.yml`:
