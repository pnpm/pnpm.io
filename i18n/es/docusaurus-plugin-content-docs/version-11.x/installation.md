...
Since v16.13, Node.js is shipping [Corepack](https://nodejs.org/api/corepack.html) for managing package managers. Esta es una función experimental, por lo que debe habilitarla ejecutando:
