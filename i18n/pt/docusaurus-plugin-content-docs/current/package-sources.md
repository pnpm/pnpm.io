...
You can specify version (range) to install using the `semver:` parameter. Por exemplo:
...
You may also install just a subdirectory from a Git-hosted monorepo using the `path:` parameter. Por exemplo:
