...
Prepara um pacote para aplicação de patches (inspirado em um comando semelhante no Yarn).

Este comando fará com que um pacote seja extraído em um diretório temporário destinado a ser editável à vontade.
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/0GjLqRGRbcY" title="A demonstração do comando de patch do pnpm" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; fullscreen"></iframe>

## Opções

### --edit-dir &lt;dir>

O pacote que precisar ser corrigido será extraído para esse diretório.

### --ignore-existing

Ignore os arquivos de correção existentes enquanto aplica correções.
