...
* Se a variável de ambiente **$XDG_CONFIG_HOME** estiver configurada, então **$XDG_CONFIG_HOME/pnpm/rc**
* No Windows: **~/AppData/Local/pnpm/config/rc**
* No macOS: **~/Library/Preferences/pnpm/rc**
* No Linux: **~/.config/pnpm/rc**
...
Exibe todas as configurações. Output is a JSON object.
