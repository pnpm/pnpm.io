...
Antes de rodar o script de instalação, você pode, opcionalmente, especificar uma variável de ambiente (. env) `PNPM_VERSION` para instalar uma versão específica do pnpm:
...
Desde a versão v16.13, Node.js inclui [Corepack](https://nodejs.org/api/corepack.html) para controlar a instalação de gerenciadores de pacotes. Esta é uma ferramenta experimental, então você precisa habilitá-la com o seguinte comando:
