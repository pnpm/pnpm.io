...
O arquivo de manifesto de um pacote. Contém todos os metadados do pacote, incluindo dependências, título, autor e etc. This is a standard preserved across all major Node.js package managers, including pnpm.
...
* [`types` ou `typings`](https://github.com/stereobooster/package.json#types)
...
> Nesse exemplo, a pasta `dist` deve conter um `package.json`
