...
Um dos melhores recursos do pnpm é que em um projeto, uma versão específica de um pacote
sempre terá um conjunto de dependências. There is one exception from
