...
Ao contrário do npm, o pnpm valida todas as opções. For example, `pnpm install --target_arch x64` will
...
is populated from the CLI options. Neste caso, você tem as seguintes opções:
