...
| [管理运行时][Managing runtimes]                   | :white_check_mark: |                              :x:                             |                              :x:                             |                                                                     |
| [管理自身的版本][Managing versions of itself]       | :white_check_mark: | :white_check_mark: |                              :x:                             |                                                                     |
...
| [脚本运行前自动安装][Auto-install before script run]  | :white_check_mark: |                              :x:                             |                              :x:                             | 在 Yarn 中，即插即用（Plug'n'Play）可确保依赖项始终保持最新。                             |
| [钩子][Hooks]                                  | :white_check_mark: | :white_check_mark: |                              :x:                             |                                                                     |
| [构建脚本安全性][Build script security]             | :white_check_mark: |                              :x:                             |                              :x:                             |                                                                     |
| [SBOM 生成][SBOM generation]                   | :white_check_mark: |                              :x:                             | :white_check_mark: | `pnpm sbom`, `npm sbom`.                            |
