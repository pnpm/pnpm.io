...
pnpm v9+ 的自动补全与旧版本的不兼容
如果你曾安装过 v9 版本之前的 pnpm 自动补全，你必须先卸载它以确保 v9+ 版本可以正常工作。
你可以通过删除点文件中包含 `__tabtab` 的代码段落来实现它。

:::

与其他通常需要插件的流行包管理器不同，pnpm
支持 Bash、Zsh、Fish 和类似 shell 的命令行制表符补全。
