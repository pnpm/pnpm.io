...
function makeEditUrl(locale, path1, path2) {
  ...
  if (locale !== DEFAULT_LOCALE) {
    return `https://crowdin.com/project/pnpm/${
      LOCALE_FULL_CODE[locale] || locale
    }`;
  }
...
module.exports = {
  ...
  scripts: ["https://buttons.github.io/buttons.js", "/homepage.js"],
      ...
      "@docusaurus/preset-classic",
      {
        docs: {
          ...
          editUrl: ({ locale, versionDocsDirPath, docPath }) =>
            makeEditUrl(locale, versionDocsDirPath, docPath),
          path: "./docs",
          routeBasePath: "/",
        ...
        blog: {
          ...
          editUrl: ({ locale, blogDirPath, blogPath }) =>
            makeEditUrl(locale, blogDirPath, blogPath),
        },
        theme: {
  ...
  i18n: {
    ...
    localeConfigs: {
      ...
      es: { label: `Español (${progress["es"].translationProgress}%)` },
      id: {
