...
```powershell
$env:PNPM_VERSION = "11.0.0-rc.2"; Invoke-WebRequest https://get.pnpm.io/install.ps1 -UseBasicParsing | Invoke-Expression
```
...
```sh
curl -fsSL https://get.pnpm.io/install.sh | env PNPM_VERSION=11.0.0-rc.2 sh -
```

If you don't have curl installed, you would like to use wget:

```sh
wget -qO- https://get.pnpm.io/install.sh | env PNPM_VERSION=11.0.0-rc.2 sh -
```
