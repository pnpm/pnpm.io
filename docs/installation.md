...
```powershell
$env:PNPM_VERSION = "11.0.3"; Invoke-WebRequest https://get.pnpm.io/install.ps1 -UseBasicParsing | Invoke-Expression
```
...
```sh
wget -qO- https://get.pnpm.io/install.sh | env PNPM_VERSION=11.0.3 sh -
```
