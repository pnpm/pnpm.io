...
```sh
curl -fsSL https://get.pnpm.io/install.sh | PNPM_VERSION=7.0.0-rc.1 sh -
```

If you don't have curl installed, you would like to use wget:

```sh
wget -qO- https://get.pnpm.io/install.sh | PNPM_VERSION=7.0.0-rc.1 sh -
```

On Windows (PowerShell):

```powershell
$env:PNPM_VERSION='7.0.0-rc.1' ; iwr https://get.pnpm.io/install.ps1 -useb | iex
```
...
```
corepack prepare pnpm@7.0.0-rc.1 --activate
```
