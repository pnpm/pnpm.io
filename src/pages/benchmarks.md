...
**Last benchmarked at**: _Jun 13, 2026, 1:47 PM_ (_daily_ updated).
...
| install | ✔ |   |   | 14.6s | 4.3s | 1.2s | 5.6s | 2.1s |
| install |   | ✔ |   | 13.1s | 6.5s | 1.8s | 3.9s | 868ms |
| install | ✔ | ✔ |   | 9.9s | 2.3s | 537ms | 3.9s | 860ms |
| install | ✔ |   | ✔ | 1.8s | 558ms | 975ms | 5.5s | n/a |
| install |   |   | ✔ | 1.8s | 579ms | 74ms | 5.3s | n/a |
| install |   | ✔ | ✔ | 1.4s | 527ms | 40ms | 3.5s | n/a |
| install | ✔ | ✔ | ✔ | 1.3s | 510ms | 37ms | 3.5s | n/a |
| update | n/a | n/a | n/a | 6.3s | 8.1s | 1.8s | 4.2s | 2.1s |

<img alt="Graph of the alotta-files results" src="/img/benchmarks/alotta-files.svg?v=e47f7b18" />
...
| install |   | ✔ | ✔ | 527ms | 40ms |
| install | ✔ | ✔ | ✔ | 510ms | 37ms |
| update | n/a | n/a | n/a | 8.1s | 1.8s |

<img alt="Graph comparing pnpm versions on the alotta-files fixture" src="/img/benchmarks/alotta-files-pnpm.svg?v=edb1925a" />