...
**Last benchmarked at**: _Aug 9, 2026, 4:06 AM_ (_daily_ updated).
...
| install | ✔ |   |   | 10.8s | 4.7s | 1s | 6.9s | 2.5s |
| install |   | ✔ |   | 10.2s | 6.5s | 2s | 5.1s | 1.1s |
| install | ✔ | ✔ |   | 6.6s | 2.3s | 667ms | 5.1s | 1.1s |
| install | ✔ |   | ✔ | 1.4s | 555ms | 57ms | 6.4s | n/a |
| install |   |   | ✔ | 1.4s | 575ms | 64ms | 6.5s | n/a |
| install |   | ✔ | ✔ | 1s | 519ms | 71ms | 4.6s | n/a |
| install | ✔ | ✔ | ✔ | 1s | 507ms | 17ms | 4.6s | n/a |
| update | n/a | n/a | n/a | 6.3s | 7.7s | 1.2s | 5.3s | 2.6s |

<img alt="Graph of the alotta-files results" src="/img/benchmarks/alotta-files.svg?v=6a7f9cdd" />
...
<img alt="Graph comparing pnpm versions on the alotta-files fixture" src="/img/benchmarks/alotta-files-pnpm.svg?v=9b429129" />