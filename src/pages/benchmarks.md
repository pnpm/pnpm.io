...
**Last benchmarked at**: _Jun 11, 2026, 6:26 PM_ (_daily_ updated).
...
| ---     | ---   | ---      | ---         | --- | --- | --- | --- | --- |
| install |   |   |   | 27.1s | 7.5s | 2.2s | 5.9s | 2.4s |
| install | ✔ |   |   | 7.8s | 2.9s | 1.1s | 5.6s | 2.1s |
| install |   | ✔ |   | 7.2s | 6.8s | 1.9s | 3.9s | 868ms |
| install | ✔ | ✔ |   | 5.2s | 1.7s | 610ms | 3.9s | 860ms |
| install | ✔ |   | ✔ | 1.1s | 2.8s | 831ms | 5.5s | n/a |
| install |   |   | ✔ | 1.1s | 3.3s | 81ms | 5.3s | n/a |
| install |   | ✔ | ✔ | 794ms | 318ms | 71ms | 3.5s | n/a |
| install | ✔ | ✔ | ✔ | 779ms | 308ms | 72ms | 3.5s | n/a |
| update | n/a | n/a | n/a | 5.4s | 7.5s | 1.8s | 4.2s | 2.1s |

<img alt="Graph of the alotta-files results" src="/img/benchmarks/alotta-files.svg?v=1b06ca15" />
...
| install |   | ✔ | ✔ | 318ms | 71ms |
| install | ✔ | ✔ | ✔ | 308ms | 72ms |
| update | n/a | n/a | n/a | 7.5s | 1.8s |

<img alt="Graph comparing pnpm versions on the alotta-files fixture" src="/img/benchmarks/alotta-files-pnpm.svg?v=3dc0c713" />