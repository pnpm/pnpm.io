...
**Last benchmarked at**: _Aug 3, 2026, 3:10 PM_ (_daily_ updated).
...
| install | ✔ |   |   | 10.8s | 4.8s | 1.1s | 6.9s | 2.5s |
| install |   | ✔ |   | 10.2s | 6.5s | 1.9s | 5.1s | 1.1s |
| install | ✔ | ✔ |   | 6.6s | 2.4s | 670ms | 5.1s | 1.1s |
| install | ✔ |   | ✔ | 1.4s | 568ms | 57ms | 6.4s | n/a |
| install |   |   | ✔ | 1.4s | 578ms | 67ms | 6.5s | n/a |
| install |   | ✔ | ✔ | 1s | 530ms | 72ms | 4.6s | n/a |
| install | ✔ | ✔ | ✔ | 1s | 515ms | 17ms | 4.6s | n/a |
| update | n/a | n/a | n/a | 6.3s | 7.9s | 1.2s | 5.3s | 2.6s |

<img alt="Graph of the alotta-files results" src="/img/benchmarks/alotta-files.svg?v=defe4fc7" />
...
| install |   | ✔ | ✔ | 530ms | 72ms |
| install | ✔ | ✔ | ✔ | 515ms | 17ms |
| update | n/a | n/a | n/a | 7.9s | 1.2s |

<img alt="Graph comparing pnpm versions on the alotta-files fixture" src="/img/benchmarks/alotta-files-pnpm.svg?v=d8ca34f5" />