...
**Last benchmarked at**: _Jul 20, 2026, 8:56 PM_ (_daily_ updated).
...
| ---     | ---   | ---      | ---         | --- | --- | --- | --- | --- |
| install |   |   |   | 22.7s | 8.5s | 2.5s | 6.9s | 2.7s |
| install | ✔ |   |   | 10.8s | 4.8s | 1.5s | 6.7s | 2.2s |
| install |   | ✔ |   | 9.7s | 6.8s | 2s | 4.9s | 1s |
| install | ✔ | ✔ |   | 7.1s | 2.4s | 713ms | 4.9s | 1s |
| install | ✔ |   | ✔ | 1.3s | 561ms | 52ms | 6.3s | n/a |
| install |   |   | ✔ | 1.3s | 585ms | 58ms | 6.2s | n/a |
| install | ✔ | ✔ | ✔ | 1s | 508ms | 14ms | 4.5s | n/a |
| install |   | ✔ | ✔ | 1s | 526ms | 64ms | 4.5s | n/a |
| update | n/a | n/a | n/a | 5.1s | 8.4s | 2.1s | 5s | 2.3s |

<img alt="Graph of the alotta-files results" src="/img/benchmarks/alotta-files.svg?v=f55e1da0" />
...
| install |   | ✔ | ✔ | 526ms | 64ms |
| install | ✔ | ✔ | ✔ | 508ms | 14ms |
| update | n/a | n/a | n/a | 8.4s | 2.1s |

<img alt="Graph comparing pnpm versions on the alotta-files fixture" src="/img/benchmarks/alotta-files-pnpm.svg?v=6a6bce1c" />