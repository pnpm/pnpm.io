...
**Last benchmarked at**: _Jun 3, 2026, 7:27 PM_ (_daily_ updated).
...
| ---     | ---   | ---      | ---         | --- | --- | --- | --- | --- |
| install |   |   |   | 27.1s | 7.7s | 2.9s | 8.2s | 3.4s |
| install | ✔ |   |   | 12.3s | 3.9s | 1.1s | 8.1s | 2.9s |
| install |   | ✔ |   | 11s | 6.8s | 2.3s | 6s | 1.3s |
| install | ✔ | ✔ |   | 7.8s | 1.8s | 457ms | 5.8s | 1.3s |
| install | ✔ |   | ✔ | 1.7s | 3s | 997ms | 7.8s | n/a |
| install |   |   | ✔ | 1.7s | 3.5s | 1.9s | 7.8s | n/a |
| install |   | ✔ | ✔ | 1.3s | 461ms | 56ms | 5.6s | n/a |
| install | ✔ | ✔ | ✔ | 1.2s | 458ms | 56ms | 5.7s | n/a |
| update | n/a | n/a | n/a | 6.6s | 7.5s | 2.9s | 6.3s | 3s |

<img alt="Graph of the alotta-files results" src="/img/benchmarks/alotta-files.svg?v=133c05c3" />
...
| install |   | ✔ | ✔ | 461ms | 56ms |
| install | ✔ | ✔ | ✔ | 458ms | 56ms |
| update | n/a | n/a | n/a | 7.5s | 2.9s |

<img alt="Graph comparing pnpm versions on the alotta-files fixture" src="/img/benchmarks/alotta-files-pnpm.svg?v=f346cad4" />