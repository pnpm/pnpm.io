...
**Last benchmarked at**: _Aug 12, 2026, 3:15 PM_ (_daily_ updated).
...
| ---     | ---   | ---      | ---         | --- | --- | --- | --- | --- |
| install |   |   |   | 27.3s | 7.1s | 2s | 6.9s | 2.9s |
| install | ✔ |   |   | 10.8s | 3.9s | 1.1s | 6.9s | 2.5s |
| install |   | ✔ |   | 10.2s | 5.5s | 1.9s | 5.1s | 1.1s |
| install | ✔ | ✔ |   | 6.6s | 1.9s | 739ms | 5.1s | 1.1s |
| install | ✔ |   | ✔ | 1.4s | 431ms | 46ms | 6.4s | n/a |
| install |   |   | ✔ | 1.4s | 499ms | 67ms | 6.5s | n/a |
| install |   | ✔ | ✔ | 1s | 394ms | 56ms | 4.6s | n/a |
| install | ✔ | ✔ | ✔ | 1s | 385ms | 13ms | 4.6s | n/a |
| update | n/a | n/a | n/a | 6.3s | 6.7s | 1s | 5.3s | 2.6s |

<img alt="Graph of the alotta-files results" src="/img/benchmarks/alotta-files.svg?v=8e00674a" />
...
<img alt="Graph comparing pnpm versions on the alotta-files fixture" src="/img/benchmarks/alotta-files-pnpm.svg?v=897a834a" />