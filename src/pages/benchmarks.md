...
**Last benchmarked at**: _Aug 1, 2026, 6:20 PM_ (_daily_ updated).
...
| ---     | ---   | ---      | ---         | --- | --- | --- | --- | --- |
| install |   |   |   | 27.9s | 7.5s | 2.1s | 6.9s | 2.9s |
...
<img alt="Graph of the alotta-files results" src="/img/benchmarks/alotta-files.svg?v=f6c83623" />
...
<img alt="Graph comparing pnpm versions on the alotta-files fixture" src="/img/benchmarks/alotta-files-pnpm.svg?v=d534e87e" />