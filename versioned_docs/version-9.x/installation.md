...
```powershell
$env:PNPM_VERSION = "9.0.0-beta.3"; iwr https://get.pnpm.io/install.ps1 -useb | iex
```

### On POSIX systems

```sh
curl -fsSL https://get.pnpm.io/install.sh | env PNPM_VERSION=9.0.0-beta.3 sh -
```

If you don't have curl installed, you would like to use wget:

```sh
wget -qO- https://get.pnpm.io/install.sh | env PNPM_VERSION=9.0.0-beta.3 sh -
```
...
```
corepack use pnpm@9.0.0-beta.3
```
...
```sh
npm install -g pnpm@9.0.0-beta.3
```

or

```sh
npm install -g @pnpm/exe@9.0.0-beta.3
```
