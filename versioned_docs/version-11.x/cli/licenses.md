...
Since v11.28.0, running `pnpm licenses list` inside a workspace package lists only the licenses of that package's dependencies. Use `--recursive` or `--filter` to include other workspace projects.
