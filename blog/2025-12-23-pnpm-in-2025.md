...
The new homepage is now built with [Bit components](https://bit.cloud/pnpm/website) and much of the work was done using Bit's AI agent: [Hope AI](https://bit.cloud/products/hope-ai).
