...
`pnpm cache list-registries` print the new encoded directory names, so scripts
that parse them need updating. Since v12.5.0, `pnpm cache list-registries`
also prints full URLs.
