...
A new [`hoistingLimits`](/settings/hoisting#hoistinglimits) setting controls how far dependencies are hoisted when using `nodeLinker: hoisted`. It mirrors yarn's `nmHoistingLimits` and accepts:
